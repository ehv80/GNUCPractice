...
/*  
*   Definición de la FUNCIÓN: 	any( char s1[], char s2[] )
*
*   Regresa la primera posición de la cadena de caracteres s1 
*   en donde se encuentre cualquier caracter de la cadena de caracteres s2,
*   o
*   -1 
*   si no contiene caracteres de s2 
*   
*/
...
int main( int c, char * argv[] )
{
	...
	printf("\nSe aplica la función   any  a ambos Arreglos de Caracteres ! y retorna: %d \n", result);
	printf("\nThe   any   function is applied to the both Array of Characters   ! and return %d  \n", result);
