/**
 * Archivo / @File:                             ej2-8_rightrot.c 
 *
 * Fecha / @Date:                               Miércoles 20 de Julio de 2022 /  Wednesday July 20, 2022
 *
...
/*  
*   Definición de la FUNCIÓN: 	rightrot( unsigned x, int n )
*  
*   Regresa el valor del entero x rotado a la derecha n posiciones de bits  
*/
...
int main( int c, char * argv[] )
{
	...
	int result = rightrot( x, 3);

	printf("\nSe aplica la función   rightrot  a x ! y retorna: %d \n", result);
	printf("\nThe   rightrot   function is applied to the x ! and return %d  \n", result);
