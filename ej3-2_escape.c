...
/*  
*   Definición de la FUNCIÓN: 	escape( cha s[], char t[] )
*  
*   Convierte caracteres como nueva línea y tabulación en secuencias de escape visibles como \n y \t
*   mientras copia la cadena t a s, usando un switch
*/
...
int escape( char s[] , char t[] )
{
	...
	while ( t[i] = s[i] )
	{
		switch(t[i])
		{
			...
			case '\t' : t[i] = '\t';
			break;
			default: printf("Caso por defecto no contemplado");
			break;
		}
		i++;
	}
...
int main( int c, char * argv[] )
{
	...
	printf("Se aplica la función escape(s,t) ");
	int resultado = escape ( s, t );
