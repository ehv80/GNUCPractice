 ...
 *
 * Implementación de Versión 3 
 * Usando Variables double 
 * No estoy seguro si Debería dar error en la ejecución por 
 * excederse del rango máximo de los valores 
 * que puede almacenar una variable de tipo double en Lenguaje de Programación C
 */
...
main()
{
	...
	while( indice <= MAX ) 
	{
		resultado = (double)(n + nMenosUno + nMenosDos); // uso un cast para la suma
		//printf("Línea Nº: %16d con Valor: %32d \n", indice, resultado);
		//printf("Línea Nº: %16.0f con Valor: %32.0f \n", indice, resultado); // da error inf en resultado
		//printf("Línea Nº: %16.0f con Valor: %16.0f \n", indice, resultado); // da error inf en resultado
		//printf("Línea Nº: %16.0f con Valor: %16.0f \n", indice, resultado); // da error inf en resultado 
		printf("Línea Nº: %16.0f con Valor: %f \n", indice, resultado); 
		
		nMenosDos = nMenosUno;
		nMenosUno = n;
		n = resultado;
		//resultado = 0.0; //Para limpiarlo !
